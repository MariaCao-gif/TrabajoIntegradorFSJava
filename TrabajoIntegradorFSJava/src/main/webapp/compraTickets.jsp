            ...
            <div class="row mb-3">
                ...
                <div class="col-6">
                    ...
                    <div class="input-group mb-3">
                        	<select id="descuentoAplicado" class="form-select" name="categoria" >
	                            <option value=""><%= request.getParameter("categoria") %></option>
                ...
                <div class="col-4">
                    ...
                    type="button" onclick="location.href='delete.jsp'">
                        Eliminar compra
                    </button>
                </div>
                <div class="col-4">
                ...
                <div class="col-4">
                    ...
                    type="button" onclick="location.href='compraTickets.html'">
                        Confirmar compra
                    </button>
                </div>
            </div>
